...
int main() {
  ...
  //Acrescentar uma mensagem de 'VALOR INVÁLIDO' no exercício caso o segundo valor informado seja ZERO.
  ...
  //Resultado
  //Programa funcionou corretamente repetindo a mensagem cada vez que o usuário digita 0.
